...
return [
     ...
     */
    'app_id' => env('WECHAT_APPID', 'wx1f4165803b3d1953'),         // AppID
    'secret' => env('WECHAT_SECRET', '2c1f6952e2f5d6452ebc42c0c74b9fae'),     // AppSecret
    'token' => env('WECHAT_TOKEN', 'yao'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'STDzKwmWMASRmdapLRHj9MMPqgbflpaK4adXDfuOGAL'),                    // EncodingAESKey
    ...
    'log' => [
        ...
        'file' => env('WECHAT_LOG_FILE', '/var/www/html/blog/storage/logs/wechat.log'),
    ],
